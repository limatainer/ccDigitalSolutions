  ...
  return (
    <div className="flex justify-center m-8">
      <div className="w-full md:w-4/5 lg:w-3/4 xl:w-2/3 ">
        ...
        {/* first case */}
        <div
          className=" text-cousseiro-300 shadow-lg shadow-costa-500 mb-6 hover:shadow-xl transition duration-500
         ease-in-out"
        >
        ...
        {/* second case */}
        <div className=" text-cousseiro-300 shadow-lg shadow-costa-500 mb-6 hover:shadow-xl transition duration-500 ease-in-out">
          <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg  ">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-400">Jun 1, 2020</span>
              <a
